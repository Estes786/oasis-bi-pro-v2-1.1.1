    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl shadow-md p-8">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-4">1. Eligibility for Refund</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-4">2. What is Covered</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-4">3. What is NOT Covered</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-4">4. Refund Process</h2>
          <h3 className="text-xl font-semibold text-gray-900 mt-4 mb-3">4.1 How to Request</h3>
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-4 mb-3">4.2 Processing Time</h3>
          <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
            <li>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-4">5. Refund Methods</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-4">6. Partial Refunds</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-4">7. Free Trial Policy</h2>
          <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
            <li>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-4">8. Cancellation vs Refund</h2>
          <h3 className="text-xl font-semibold text-gray-900 mt-4 mb-3">8.1 Cancellation (After 14 Days)</h3>
          <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-4 mb-3">8.2 Refund (Within 14 Days)</h3>
          <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-4">9. Disputed Charges & Chargebacks</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-4">10. Exceptions</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-4">11. Enterprise Plans</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-4">12. Contact for Refund</h2>
