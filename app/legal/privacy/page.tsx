    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white rounded-xl shadow-md p-8">
          ...
          <h3 className="text-xl font-semibold text-gray-900 mt-4 mb-3">2.1 Information You Provide</h3>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-4">4. Data Security</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-4">5. Data Retention</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-4">6. Data Sharing and Disclosure</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-4">7. Your Rights (GDPR & Indonesian Law)</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-4">10. Cookies Policy</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-4">11. Third-Party Links</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-4">12. Changes to This Policy</h2>
          <p className="text-gray-700 mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mt-6 mb-4">14. Compliance</h2>
