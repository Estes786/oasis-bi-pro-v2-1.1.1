      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <PricingCard
            ...
            cta="Hubungi Sales"
            ctaLink="/legal/contact?subject=business-plan"
          />
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <FAQItem
              ...
              answer="Kami support pembayaran via Midtrans: Credit Card (Visa, Mastercard, JCB), Virtual Account (BCA, Mandiri, BNI, BRI, Permata), E-wallet (GoPay, DANA, OVO, ShopeePay), dan QRIS."
            />
            <FAQItem
